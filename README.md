...
**Mapping Toolkit** - это мультитул для мапперов, который дает больше возможностей для маппинга и разработки ваших собственных проектов. Предоставляет множество дополнительных функции для взаимодействия с игровыми объектами и текстурами, управления камерой и эффектами, а так же содержит подсказки и справочные материалы. Для управления всеми возможностями предоставлен удобный графический интерфейс на [imgui](https://www.blast.hk/threads/19292/). Больше информации по возможностям тулкита на [wiki](https://github.com/ins1x/MappingToolkit/wiki).  

Адаптирован под [TRAINING-SANDBOX](https://training-server.com/), и частично для [Absolute Play](sa-mp.ru). Для них исправляет некоторые баги игры, дополняет серверные команды и диалоги. Может работать и на других серверах, но незначительная часть возможностей будет недоступна.   
