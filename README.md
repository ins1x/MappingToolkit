...
- Поиск текстур онлайн через https://textures.xyin.ws/
...
- В настройках чата можно менять правила фильтрации по паттернам (chatfilter.txt)
...
- Исправлен баг сервера с зависанием аудиострима после выхода из мира
