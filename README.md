...
> Если вы столкнулись с проблемой по запуску либо использованию скрипта, то ознакомьтесь с [FAQ - Ответы на часто задаваемы вопросы по скрипту](https://github.com/ins1x/MappingToolkit/wiki/FAQ-%D0%BF%D0%BE-MappingToolkit)
